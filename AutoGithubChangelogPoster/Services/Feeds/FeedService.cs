...
public partial class FeedService
{
    ...
    private const string FeedUrlEnvVar = "GITHUB_CHANGELOG_FEED_URL";
    ...
    private ChangelogEntry? CreateEntry(SyndicationItem item)
    {
    ...
    private static List<ChangelogMediaItem> ExtractMedia(string html)
    {
        ...
        var media = new List<ChangelogMediaItem>();
        ...
        foreach (Match match in ImagePattern().Matches(html))
        {
            ...
            {
                media.Add(new ChangelogMediaItem(url, ChangelogMediaType.Image));
            }
        }
...
public sealed class ChangelogEntry
{
    ...
    public required IReadOnlyList<ChangelogMediaItem> Media { get; set; }
    public required string ChangelogType { get; set; }
    public DateTimeOffset Updated { get; set; }
}

public sealed record ChangelogMediaItem(string Url, ChangelogMediaType MediaType);

public enum ChangelogMediaType
{
    Image,
    Video
}
